...
alias speed='~/GitFiles/mac_dotfiles/speed.sh'
...
alias ff="zsh ~/GitFiles/mac_dotfiles/fzfvim.sh"
alias ft="zsh ~/GitFiles/mac_dotfiles/rg_bat_fzf.sh"
#white space killer 
...
alias acp='zsh ~/GitFiles/mac_dotfiles/acp.sh'
